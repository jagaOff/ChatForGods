  ...
  private getCloseButtonHtml(type: string): string {
    return `
      <button aria-label="Close"
              class="ms-auto -mx-1.5 -my-1.5 bg-background text-text hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 toast-close-button"
